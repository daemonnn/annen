...
if (db.has(`prefix_${message.guild.id}`) === false) {
  ...
  if (y === 150) {
    ...
    .setColor("RANDOM")
    .setAuthor(`Tebrikler!`)
    .setDescription(`Sunucu puanı, ${y} seviyesine ulaştığı için NeruaL Premium özelliği aktif edildi. İyi kullanımlar!\nPremium Özellikleri: https://nerualpanel.cf/premium`)
